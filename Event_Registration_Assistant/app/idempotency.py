...
def notification_dedupe_key(participant_id: str, message: str, day: date) -> str:
    """The same message to the same participant on the same day is one notification."""
    return _sha256(canonical_json([participant_id, " ".join(message.split()), day.isoformat()]))
