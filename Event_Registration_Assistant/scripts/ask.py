"""Queue a question and wait for the answer.
    ...
    python -m scripts.ask --participant 22CS045 "Is Designing Data-Intensive Applications available?"
"""
import argparse
import time
...
def main() -> None:
    ...
    p.add_argument("text")
    p.add_argument("--participant", default="22CS045")
    p.add_argument("--thread")
    a = p.parse_args()
    store, _ = open_stores()
    thread = a.thread or store.create_thread(a.participant)
